    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/seller-dashboard" className="flex items-center text-gray-600 hover:text-gray-900">
              <ArrowLeft className="h-4 w-4 mr-2" />
              Back to Dashboard
            </Link>
            <div className="flex items-center">
              <span className="text-gray-700 text-sm sm:text-base">Welcome, {userName}</span>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-gray-600 text-sm sm:text-base">Communicate with potential customers.</p>
        </div>
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div className="flex-1 min-w-0">
                            <h3 className="font-medium text-gray-900 text-sm sm:text-base truncate">{user}</h3>
          ...
          <div className="lg:col-span-2">
            <Card className="h-[500px] sm:h-[600px] flex flex-col">
              {selectedConversation ? (
                <>
                  <CardHeader>
                    <CardTitle className="text-lg sm:text-xl">{selectedConversation}</CardTitle>
