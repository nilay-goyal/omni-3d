...
import { Printer, Upload, Map, MessageCircle, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Find local 3D printer owners and get your items printed.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Upload your 3D model file to get started with finding a printer.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link to="/upload-file">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Browse a map of nearby 3D printer owners and their capabilities.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link to="/printer-map">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                View and manage your conversations with 3D printer owners.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link to="/messages">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Start by uploading the 3D model you want to print.</p>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-green-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Browse the map to find 3D printer owners near you.</p>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-purple-50 rounded-lg">
                  <MessageCircle className="h-8 w-8 text-purple-600 mr-4" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Step 3: Send a Message</h3>
                    <p className="text-gray-600">Contact sellers to discuss your printing needs.</p>
                  </div>
                </div>
              </div>
            </CardContent>
